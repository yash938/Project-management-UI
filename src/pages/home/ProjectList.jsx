                    ...
                    <CardContent className='mt-5'>
                        <ScrollArea className='space-y-7 h-[70vh]' >
                            <div>
                                ...
                                <div className='pt-5'>
                                    <RadioGroup className="space-y-2 pt-5" defaultValue='all' onValueChange={(value)=>handleFilterChange("category",value)}>
                            ...
                            <div className='pt-9'>
                                ...
                                <div className='pt-5'>
                                    <RadioGroup className="space-y-2 pt-5" defaultValue='all' onValueChange={(value)=>handleFilterChange("tags",value)}>
